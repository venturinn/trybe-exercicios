...
// Solução presente no gabarito da questão: 
...
const checker = (sort, number) => sort === number;

const sorteio = (number, verificar) => {

let oEscolhido = Math.floor((Math.random() * 5) + 1);

const resultado = verificar(oEscolhido, number);
